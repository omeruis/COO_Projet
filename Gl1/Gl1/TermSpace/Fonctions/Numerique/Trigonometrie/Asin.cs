...
{
    /// <summary>
    /// Classe gerant les calculs de la fonction Arc sin
    /// </summary>
    public class Asin : Operation
    {
        /// <summary>
        /// Constructeur de la classe asin
        /// </summary>
        /// <param name="args">Les termes qui vont etre utilises pour le calcul</param>
        public Asin(Term[] args)
            : base("asin", args, 1)
        {
        }
        /// <summary>
        ...
        /// <example>Si le terme vaut 1 retourne : asin(1)</example>
        public override string ToString()
        {
            return "asin(" + terms[0].ToString() + ")";
        }
    }
}
