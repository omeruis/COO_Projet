...
{
    /// <summary>
    /// Classe gerant les calculs de la fonction Tangente
    /// </summary>
    public class Tangente : Operation
    {
        /// <summary>
        /// Constructeur de la classe tangente
        /// </summary>
        /// <param name="args">Les termes qui vont etre utilises pour le calcul</param>
        public Tangente(Term[] args)
            : base("tan", args, 1)
        {
    }
        /// <summary>
        ...
        /// <example>Si le terme vaut 1 retourne : tan(1)</example>
