...
{
    /// <summary>
    /// Classe gerant les calculs pour la conversion en radiant
    /// </summary>
    public class ToRadiant : Operation
    {
        /// <summary>
        /// Constructeur de la classe ToRadiant
        /// </summary>
        /// <param name="args">Les termes qui vont etre utilises pour le calcul</param>
        public ToRadiant(Term[] args)
            : base("toradiant", args, 1)
            {
            }
        /// <summary>
        ...
        public override Term Interpret()
        {
            try
            {
                ...
                if (res.GetType().Equals(typeof(Numeric)))
                {
                    ...
                    double val = termVal * Math.PI / 180;
        ...
        /// <example>Si le terme vaut 1 retourne : toradiant(1)</example>
        public override string ToString()
        {
            return "toradiant(" + terms[0].ToString() + ")";
        }
    }
}