...
{
    /// <summary>
    /// Classe gerant les calculs pour la conversion en degre
    /// </summary>
    public class ToDegree : Operation
    {
        /// <summary>
        /// Constructeur de la classe ToDegree
        /// </summary>
        /// <param name="args">Les termes qui vont etre utilises pour le calcul</param>
        public ToDegree(Term[] args)
            : base("todegree", args, 1)
        {
    }
        /// <summary>
        ...
        public override Term Interpret()
        {
            try
            {
                ...
                if (res.GetType().Equals(typeof(Numeric)))
                {
                    ...
                    double val = termVal * 180 / Math.PI;
        ...
        /// <example>Si le terme vaut 1 retourne : todegree(1)</example>
        public override string ToString()
        {
            return "todegree(" + terms[0].ToString() + ")";
        }
    }
}